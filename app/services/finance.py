...
class Finance:
    ...
    def __calc_statistics(self) -> dict:
        ...
        last_rsi = self.__calc_rsi(delta=df['Diff'])
...
Retorno cumulativo: {stock_statistics.get('cumulative_return', 'N/A'):.4f}
...
RSI (Último valor): {stock_statistics.get('last_rsi', 'N/A'):.2f}
"""